...
$(document).ready(function() {
    $("form").sisyphus({
        excludeFields: $("[name=country], [name=language], [name=s1], [name=s2], [name=s3], [name=offer_id], [name=landing], [name=campaign], [name=request_id], [name=referer], [name=order_source], [name=return_url], [name=timezone], [name=jswork], [name=frompopup]")
    });
